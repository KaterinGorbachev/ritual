  ...
  return (
    <Section>
      ...
      >
        ...
        <div className="relative z-1 lg:mt-8 rounded-card bg-cream/55 px-6 py-10 text-center backdrop-blur-md md:px-16 md:py-14 flex flex-col items-center justify-center gap-2 w-full ">
